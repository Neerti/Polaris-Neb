...
/datum/trade_hub/Process(wait, times_fired)
	for(var/datum/merchant/merchant in merchants)
...
/// This can be disabled in order to allow someone to manually define specific types in order to fit a certain theme,
...
/datum/trade_hub/proc/get_permanent_merchant_types()
	return get_non_abstract_types(/datum/merchant) - get_transient_merchant_types()

/datum/trade_hub/proc/get_transient_merchant_types()
	return get_non_abstract_types(/datum/merchant/transient) - get_rare_transient_merchant_types()

/datum/trade_hub/proc/get_rare_transient_merchant_types()
	return get_non_abstract_types(/datum/merchant/transient/rare)
