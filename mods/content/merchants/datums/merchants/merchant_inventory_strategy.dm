...
/// Makes everything be on the active list unconditionally, i.e. they will always sell (or buy) their whole potential stock.
/// Use with care for merchants that offer a lot of stuff.
