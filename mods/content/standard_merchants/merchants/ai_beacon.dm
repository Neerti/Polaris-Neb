...
/datum/merchant/trading_beacon
	...
	name_background = /decl/background_detail/heritage/synthetic
...
/decl/merchant_potential_commodities/trading_beacon_supply
	type_instructions = list(
		...
		/obj/item/backpack/ert							= MERCHANT_EXCLUDE_ALL,
		...
		/obj/item/plants								= MERCHANT_INCLUDE_THIS_TYPE,
		/obj/item/ore									= MERCHANT_INCLUDE_THIS_TYPE,
...
/decl/merchant_potential_commodities/trading_beacon_demand
	type_instructions = list(
		...
		/obj/item/weldingtool					= MERCHANT_INCLUDE_THIS_TYPE,
